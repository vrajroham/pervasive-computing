...
<title>Pizza Shop : Address Confirmation</title>
  ...
  <body bgcolor="black">
    ...
    <table width="100%"><tr><td width="70%">
        ...
        <center>
	<table border=1 width="80%" cellspacing=10 cellpading=6 id="items">
		<tr bgcolor="brown">
			<th width="10%">#</th>
			<th width="35%"><font color="white">ITEM NAME</font></th>
			<th width="15%"><font color="white">SIZE</font></th>
			<th width="15%"><font color="white">QTY</font></th>
			<th width="25%"><font color="white">PRICE</font></th>
        </tr>    
				<% 
				    int x;
				    ...
				    String[] sizes=request.getParameter("isize").split(",");
				    for(x=0; x<items.length; x++){ %>
				            <tr>
				            	<td><center><b><%=(x+1)%></td>
				            	<td><center><b><%=items[x]%></td>
						<td><center><b><%=sizes[x]%></td>
						<td><center><b><%=qty[x]%></td>
				            	<td><center><b><%=price[x]%></td>
				            </tr>
				   <% }
                		%>
     	<tr>
			<th width="10%"></th>
			<th width="65%"></th><th  width="65%"></th>
			<th width="25%" colspan=2 bgcolor="brown"><font color="white"><center><b>Rs. <% out.print(request.getParameter("total"));%> /-</font></th>
        </tr>
	</table>
    </center>
    <br />
	...
	<input type="hidden" name="qty" value="<% out.print(request.getParameter("qty"));%>" />
