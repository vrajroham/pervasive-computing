...
<font color="#FFFFFF">
	<%
		String iList=request.getParameter("items");
	...
	<% String bfile="/home/student/apache/tomcat/apache-tomcat-7.0.62/webapps/Raj133/orders.xml"; %>
	<% try{
		PrintWriter pw=new PrintWriter(new FileOutputStream(bfile,true));
		String data="<item list=\""+iList+"\" cname=\""+fname+"\" city=\""+city+"\" street=\""+street+"\" mobile=\""+mobile+"\" price=\""+iPrice+"\" quantity=\""+iQty+"\">"+fname+"</item>";
		pw.println(data);
		pw.close();
		out.println("Order Saved");
	}catch(Exception e){
	    out.println(e);
	} 
%>
